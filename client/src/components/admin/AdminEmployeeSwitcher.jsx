...
const AdminEmployeeSwitcher = () => {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      {isOpen && (
        <div className="absolute right-0 mt-2 w-80 sm:w-96 rounded-xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-soft z-50 p-3.5 space-y-3 animate-in fade-in slide-in-from-top-2 duration-150">
          {/* Header */}
          ...
          <div className="relative">
            ...
            <input
              ...
              className="theme-input w-full pl-8 pr-7 text-xs"
            />
            {search && (
              <Tooltip label="Clear search" side="left">
            ...
            <div className="p-3 rounded-xl bg-brand-50/70 dark:bg-brand-950/40 border border-brand-200/80 dark:border-brand-900/60 space-y-2.5 animate-in fade-in duration-150">
              ...
              <div className="grid grid-cols-3 gap-1.5 pt-1 text-[10px] font-semibold">
                ...
                <button
                  ...
                  className="p-1.5 rounded-lg bg-white dark:bg-slate-900 hover:bg-emerald-500 hover:text-white dark:hover:bg-emerald-600 border border-slate-200 dark:border-slate-800 text-slate-700 dark:text-slate-300 transition-all flex items-center justify-center gap-1 shadow-sm group"
                >
                ...
                <button
                  ...
                  className="p-1.5 rounded-lg bg-white dark:bg-slate-900 hover:bg-amber-500 hover:text-white dark:hover:bg-amber-600 border border-slate-200 dark:border-slate-800 text-slate-700 dark:text-slate-300 transition-all flex items-center justify-center gap-1 shadow-sm group"
                >
                ...
                <button
                  ...
                  className="p-1.5 rounded-lg bg-white dark:bg-slate-900 hover:bg-brand-500 hover:text-white dark:hover:bg-brand-600 border border-slate-200 dark:border-slate-800 text-slate-700 dark:text-slate-300 transition-all flex items-center justify-center gap-1 shadow-sm group"
                >
                  <DollarSign className="w-3 h-3 text-brand-500 group-hover:text-white" />
                  <span>Payroll</span>
                </button>
                <button
                  type="button"
